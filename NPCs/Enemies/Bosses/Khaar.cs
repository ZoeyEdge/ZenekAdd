...
{
	internal class KhaarHead : Khaar
	{
	...
	internal class KhaarBody : Khaar
	{
		public override void SetDefaults() {
	...
	internal class KhaarTail : Khaar
	{
		public override void SetDefaults() {
	...
	public abstract class Khaar : Worm
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Khaar");
		}
	...
	public abstract class Worm : ModNPC
	{
        ...
        {		
			if (Main.rand.NextFloat() < .2500f)
	            Item.NewItem(npc.getRect(), mod.ItemType ("AntagoSword"));
			if (Main.rand.NextFloat() < .2500f)
	            Item.NewItem(npc.getRect(), mod.ItemType ("AntagoCrossbow"));
			if (Main.rand.NextFloat() < .2500f)
	            Item.NewItem(npc.getRect(), mod.ItemType ("AntagoStaff"));
			if (Main.rand.NextFloat() < .2500f)
	            Item.NewItem(npc.getRect(), mod.ItemType ("KhaarsFang"));
			// NOTE: Due to this, it also has a chance to drop nothing... Better than what was before.
        }
	}
}