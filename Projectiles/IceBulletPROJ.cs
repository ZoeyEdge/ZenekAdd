...
{
	public class IceBulletPROJ : ModProjectile
	{
		public override string Texture => "ZenekAdd/Items/IceBullet";
		...
		public override void SetDefaults() 
		{
			...
			projectile.timeLeft = 690;  //The live time for the projectile (60 = 1 second, so 600 is 10 seconds)
